        ...
        const AdminCard(
          child: Column(
            ...
            children: [
              AdminSectionTitle(
                title: 'Account Info',
                subtitle: 'A short summary of the admin account used in this dashboard.',
              ),
              SizedBox(height: 16),
              _InfoRow(label: 'Role', value: 'Admin'),
              SizedBox(height: 10),
              _InfoRow(label: 'Data Source', value: 'Firebase Authentication + Firestore'),
            ],
          ),
        ),
      ],
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            hintText: hintText,
            filled: true,
            fillColor: enabled ? const Color(0xFFFBFBFD) : const Color(0xFFF4F2F8),
